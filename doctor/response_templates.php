...
$page_title = 'Medical Response Templates - Village Health Connect';

// Handle template usage tracking
if ($_POST && isset($_POST['use_template'])) {
    $template_id = $_POST['template_id'] ?? '';
    $case_id = $_POST['case_id'] ?? '';

    if ($case_id && $template_id) {
        header("Location: respond_case.php?id=" . $case_id . "&template=" . urlencode($template_id));
        exit();
    }
}
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1 class="mb-2 text-primary">
                            <i class="fas fa-clipboard-list me-2"></i>Medical Response Templates
                        </h1>
                        <p class="text-muted mb-0">
                            Professional medical templates to streamline your patient consultations and ensure comprehensive care
                        </p>
                    </div>
                    <div>
                        ...
                        <a href="all_escalated.php" class="btn btn-success">
                            <i class="fas fa-stethoscope me-1"></i>View Cases
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="template-categories">
                <div class="d-flex flex-wrap gap-2 justify-content-center">
                    ...
                    <button class="btn btn-outline-info category-filter" data-category="General Medicine">
                        <i class="fas fa-user-md me-1"></i>General Medicine
                    </button>
                    ...
                    <button class="btn btn-outline-secondary category-filter" data-category="Administrative">
                        <i class="fas fa-calendar-check me-1"></i>Administrative
                    </button>
                </div>
            </div>
        </div>
                ...
                <div class="card shadow h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="template-preview mb-3 flex-grow-1">
                            <h6><i class="fas fa-eye text-info me-2"></i>Template Preview:</h6>
                        ...
                        <div class="template-actions mt-auto">
                            <div class="d-grid gap-2">
                                ...
                                <button class="btn btn-success" onclick="useTemplate('<?php echo $template_id; ?>')">
                                    <i class="fas fa-clipboard me-2"></i>Use This Template
                                </button>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="templateModalLabel">
                    <i class="fas fa-clipboard-list me-2"></i>Medical Template
                </h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="useTemplateBtn">
                    <i class="fas fa-clipboard me-1"></i>Use This Template
                </button>
...
function viewFullTemplate(templateId) {
    ...
    if (template) {
        document.getElementById('templateModalLabel').innerHTML = 
            `<i class="fas fa-clipboard-list me-2"></i>${template.title}`;
...
function useTemplate(templateId) {
    // For demo purposes, we'll redirect to a case response page
    // In real implementation, this could open a case selector or go to the most recent case
    const urlParams = new URLSearchParams(window.location.search);
    const caseId = urlParams.get('case_id');

    if (caseId) {
        window.location.href = `respond_case.php?id=${caseId}&template=${templateId}`;
    } else {
        // Show case selector or redirect to cases page
        alert('Please select a case to apply this template to.');
        window.location.href = 'all_escalated.php';
    }
}
