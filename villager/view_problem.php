                        ...
                        <?php foreach ($medical_responses as $response): ?>
                            <div class="medical-response-item mb-4 p-3 border rounded <?php echo $response['urgency_level'] === 'critical' ? 'border-danger' : 'border-success'; ?>">
                                ...
                                <div class="medical-response-content">
                                    ...
                                    <?php if ($response['recommendations']): ?>
                                        <div class="mb-2">
                                    ...
                                    <?php if ($response['follow_up_required']): ?>
                                        <div class="alert alert-warning mt-3 mb-0">
                                            ...
                                            <strong>Important:</strong> This case requires follow-up medical monitoring. 
                                            Please stay in contact with your AVMS officer and follow all medical instructions carefully.
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <?php if ($problem['avms_name']): ?>
                        <div class="mb-3">
                            <strong><i class="fas fa-user-tie text-success"></i> AVMS Officer:</strong><br>
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <?php if ($problem['avms_phone'] && $_SESSION['user_role'] !== 'avms'): ?>
                            <a href="tel:<?php echo $problem['avms_phone']; ?>" class="btn btn-outline-success btn-sm">
                                <i class="fas fa-phone"></i> Call AVMS
                            </a>
                        <?php endif; ?>
